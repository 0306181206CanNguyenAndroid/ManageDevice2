...
namespace DeviceManage
{
    ...
    public delegate void FireEventForAction_ReportSuccess(object sender, Action_ReportSuccessEventArgs e);
    ...
    public class Action_ReportSuccessEventArgs : EventArgs
    {
